---
title: AutoStamp
description: A desktop application that can be used to stamp all documents in a chosen folder, using a chosen stamp image.
order: 10
group: Other
tags: [OpenCV, Python, Tkinter, GUI, Desktop app]
image: /projects/autostamp/overview.png
github: https://github.com/hasauino/auto_stamp
---

![](/projects/autostamp/overview.png)
...
![how to](/projects/autostamp/howto.gif)
